...
def neud_level(age):
    ...
    norg_age = (min(age, 15) - 7) // 2
    result = 21 - norg_age * 1.5
    return result
...
def test(P1, P2, P3, age):
    ...
    if age < 7:
        ...
        ruffer = ruffier_index(P1, P2, P3)
        result = txt_res[ruffier_result(ruffer, neud_level(age))]
        return f'{txt_index} {str(ruffer)} \n{txt_workheart} {result}'
