...
class ImageProcessor():
   ...
   def do_bw(self):
       ...
       self.prefix = 'gray_'
       self.saveImage(self.gray)
       self.showImage(os.path.abspath(self.new_file))
   ...
   def do_flip(self):
       ...
       self.prefix = 'mirror_'
       self.saveImage(self.mirror)
       self.showImage(os.path.abspath(self.new_file))

   def do_left(self):
       self.left = self.image.transpose(Image.ROTATE_90)
       self.prefix = 'left_'
       self.saveImage(self.left)
       self.showImage(os.path.abspath(self.new_file))

   def do_right(self):
       self.right = self.image.transpose(Image.ROTATE_270)
       self.prefix = 'right_'
       self.saveImage(self.right)
       self.showImage(os.path.abspath(self.new_file))


   def do_sharp(self):
        self.sharp = self.image.filter(ImageFilter.BLUR)
        self.prefix = 'sharp_'
        self.saveImage(self.sharp)
        self.showImage(os.path.abspath(self.new_file))
