...
mess_box.setText('Изменения сохранены')
mess_box.setWindowTitle('Info')
mess_box.setStyleSheet("QLabel{min-width: 200px;}")
mess_box.setWindowIcon(QIcon("img.png"))

# mess_box.setIcon(QMessageBox.NoIcon)
# mess_box.resize(400, 200)
